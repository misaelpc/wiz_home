# Habla y Elixir Activa las Luces: Domótica con Procesamiento de Audio en Tiempo Real
...
## Slide 3: ¿Qué es WizHome?

# WizHome: Sistema de Domótica Inteligente

**Un sistema completo de control de iluminación inteligente**
...
## Slide 5: Arquitectura de Voz - Detalle
...
└──────┬──────┘
       ...
       ▼
┌─────────────┐
│ Audio Chunk │  ← Segmentación en chunks (3s)
│   Filter    │
└──────┬──────┘
       │
       ▼
┌─────────────┐
│   Voice     │  ← Orquestación y debouncing
│ Controller  │
│ (GenServer) │
└──────┬──────┘
       │
...
## Slide 6: Arquitectura Web - LiveView
...
## Slide 7: ¿Por qué Elixir? - Parte 1

# ¿Por qué Elixir para este Proyecto?
...
## Slide 8: ¿Por qué Elixir? - Parte 2

# ¿Por qué Elixir? (Continuación)
...
## Slide 9: ¿Por qué Elixir? - Parte 3
...
## Slide 10: ¿Por qué Elixir? - Parte 4
...
## Slide 12: Características - Control por Voz
...
## Slide 13: Características - Interfaz Web
...
## Slide 14: Características - Selector de Color
...
### Implementación:
- JavaScript Hook para color wheel
- LiveView para estado y actualizaciones
- Conversión HSL ↔ RGB en Elixir

---

## Slide 15: Patrones de Diseño - GenServer
...
## Slide 16: Patrones de Diseño - Task.async_stream
...
### Resultado:
- Procesa múltiples chunks simultáneamente
- Mejor latencia que procesamiento secuencial

---

## Slide 17: Patrones de Diseño - LiveView
...
## Slide 18: Membrane - Procesamiento de Audio
...
- Envío a GenServer para procesamiento

---

## Slide 19: Base de Datos - Ecto
...
## Slide 20: Comunicación UDP con Luces
...
## Slide 21: Lecciones Aprendidas - Parte 1
...
## Slide 22: Lecciones Aprendidas - Parte 2
...
## Slide 23: Lecciones Aprendidas - Parte 3
...
## Slide 24: Métricas y Performance
...
1. **Control por Voz**
   - Comando: "Enciende las luces"
   - Observar procesamiento en tiempo real
...
3. **Control Global**
   - Aplicar color a todas las luces
   - Toggle todas
